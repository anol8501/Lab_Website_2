...
function loadStatsPage()
{
	...
	{
		/*alert(table.rows[row_counter].cells[2].innerHTML);
		alert(table.rows[row_counter].cells[3].innerHTML);*/
...
function switchPlayers(playerNum) {
	...
	document.getElementById("player_img").alt = players[playerNum].text;

	document.getElementById("p_yards").innerHTML = players[playerNum].pass_yards;

	document.getElementById("r_yards").innerHTML = players[playerNum].receiving_yards;
